...
class Renderer {
    ...
    async init() {
            ...
            let prefilterKernel = ti.classKernel(
                ...
                () => {
                    ...
                    let getLambertianImportanceSample = (normal, xi) => {
                        ...
                        let localSpaceDirection = [sinTheta * cos(phi), sinTheta * sin(phi), cosTheta];
        ...
        this.renderKernel = ti.classKernel(this, { camera: ti.engine.Camera.getKernelType() }, (camera) => {
            ...
            let evalIBL = (material, normal, viewDir) => {
                ...
                if (ti.static(this.scene.ibl !== undefined)) {
                    ...
                    let specularLight = sRGBToLinear(
                        this.tonemap(
                            ti.textureSample(this.iblGGXFiltered, reflectionUV.concat([material.roughness])).rgb,
                            this.scene.ibl.exposure
                        )
                    );
