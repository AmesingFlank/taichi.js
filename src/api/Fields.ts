...
function field( primitiveType:PrimitiveType, dimensions: number[]) : Field{
...
let Vector = {
    field : (n:number, primitiveType:PrimitiveType, dimensions:number[]):Field => {
...
let Matrix = {
    field : (n:number, m:number, primitiveType:PrimitiveType, dimensions:number[]):Field => {
